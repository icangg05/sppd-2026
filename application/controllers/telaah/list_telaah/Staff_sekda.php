...
class Staff_sekda extends public_Controller {
	...
	public function index()
	{
		...
		$config = array ();
		$config ["base_url"] = base_url () . "list_telaah/staff_sekda/index";
		$config ["total_rows"] = $this->m_sekda->record_count3($staff_sekda[0]['subbagian_id']);
		$config ["per_page"] = 25;
		...
		$this->data['staff_sekda'] = $this->m_sekda->datakasubagstaf($config ["per_page"], $page, $staff_sekda[0]['subbagian_id']);
		$this->render('list_telaah/staff_sekda/content');
	}
	...
	public function search()
	{
		...
		$staff_sekda = $this->m_relasi_sekda->getsubbagian($this->ion_auth->user()->row()->id);
		$config = array ();
		$config ["base_url"] = base_url () . "list_telaah/staff_sekda/search/".$query."/".$column;
		$config ["total_rows"] = $this->m_sekda->record_count_search3($column,$query, $staff_sekda[0]['subbagian_id']);
		$config ["per_page"] = 25;
		...
		$this->data['links'] = $this->pagination->create_links ();
		$this->data['staff_sekda'] = $this->m_sekda->data_search3($column,$query,$config ["per_page"], $page, $staff_sekda[0]['subbagian_id']);
		$this->render('list_telaah/staff_sekda/content');
	}
	...
	public function index_admin()
	{
		...
		$config = array ();
		$config ["base_url"] = base_url () . "list_telaah/staff_sekda/index_admin";
		if($staff_sekda){
			$config ["total_rows"] = $this->m_sekda->record_count_staffsekda_bag($staff_sekda[0]['bagian_id']);
		} else {
			$config ["total_rows"] = $this->m_sekda->record_count_staffsekda();
		}
		$config ["per_page"] = 25;
		$config ["uri_segment"] = 4;
		$choice = $config ["total_rows"] / $config ["per_page"];
		...
		$this->data['links'] = $this->pagination->create_links ();
		if($staff_sekda){
			$this->data['staff_sekda'] = $this->m_sekda->data_staffsekda_bag($config ["per_page"], $page, $staff_sekda[0]['bagian_id']);
		} else {
			$this->data['staff_sekda'] = $this->m_sekda->data_staffsekda($config ["per_page"], $page);
		}
		$this->render('list_telaah/staff_sekda/content');
	}
	...
	public function search_admin()
	{
		...
		$staff_sekda = $this->m_relasi_sekda->getkabag($this->ion_auth->user()->row()->id);
		$config = array ();
		$config ["base_url"] = base_url () . "list_telaah/staff_sekda/search_admin/".$query."/".$column;
		if($staff_sekda){
		...
		$this->data['links'] = $this->pagination->create_links ();
		if($staff_sekda){
			$this->data['staff_sekda'] = $this->m_sekda->data_search_staffsekda_bag($column,$query,$config ["per_page"], $page, $staff_sekda[0]['bagian_id']);
		} else {
			$this->data['staff_sekda'] = $this->m_sekda->data_search_staffsekda($column,$query,$config ["per_page"], $page);
		}
	...
	public function create_view()
	{
		$staff_sekda = $this->m_relasi_sekda->getsubbagian($this->ion_auth->user()->row()->id);
		if($staff_sekda){
			$this->data['pegawai'] = $this->m_sekda->pegawai_setda($this->ion_auth->user()->row()->skpd_id, $staff_sekda[0]['bagian_id']);
		...
		$this->render('list_telaah/staff_sekda/insert');
	}
	...
	public function create()
	{
		...
		{	
			...
			if(!$this->upload->do_upload()){
				...
				redirect('list_telaah/staff_sekda');
			}else {
	...
	public function detail()
	{
		...
		if(!isset($this->data['entry'][0]) || $this->data['entry'][0] == ""){
			...
			$this->render('list_telaah/staff_sekda/detail');
		}
	}
	//View Detail Data
