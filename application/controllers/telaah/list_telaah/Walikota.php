...
class Walikota extends public_Controller {
	...
	{
		$config = array ();
		$config ["base_url"] = base_url () . "list_telaah/walikota/index";
		...
		$this->data['walikota'] = $this->m_sekda->datawalikota($config ["per_page"], $page);
		$this->render('list_telaah/walikota/content');
	}
	...
	public function search()
	{
		...
		$config = array ();
		$config ["base_url"] = base_url () . "list_telaah/walikota/search/".$query."/".$column;
		...
		$this->data['links'] = $this->pagination->create_links ();
		$this->data['walikota'] = $this->m_sekda->data_search_walikota($column,$query,$config ["per_page"], $page);
		$this->render('list_telaah/walikota/content');
	}
	...
	public function create_view()
	{
		...
		$this->render('list_telaah/walikota/insert');
	}
	...
	public function detail()
	{
		...
		if(!isset($this->data['entry'][0]) || $this->data['entry'][0] == ""){
			...
			$this->render('list_telaah/walikota/detail');
		}
	}
	public function get(){
