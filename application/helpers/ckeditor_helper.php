...
function cke_initialize($data = array()) {
	...
	if(!defined('CI_CKEDITOR_HELPER_LOADED')) {
		...
		$return =  '<script type="text/javascript" src="'.base_url(). $data['path'] . '/styles.js"></script>';
		$return =  '<script type="text/javascript" src="'.base_url(). $data['path'] . '/build-config.js"></script>';
