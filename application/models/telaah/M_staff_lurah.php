...
class M_staff_lurah extends CI_Model
{
	// TAMPILAN DASHBOARD-----------------------------------------------------------------------------------------//
	
	// Total List Telaah Staff Lurah
	...
	// Total List Telaah Staff Lurah yang masuk
	...
	// Total List Telaah Staff Lurah yang diproses
	...
	// Total List Telaah Staff Lurah yang diterima
	...
	// Total List Telaah Staff Lurah yang ditolak
	...
	public function record_count($skpd_id) {
		return $this->db->count_all("table_telaah 
			...
			WHERE telaah_kategori='7' AND table_pegawai.skpd_id = '$skpd_id'");
	}
	
	public function record_count_search($column, $data,$skpd_id) {
		return $this->db->count_all("table_telaah WHERE telaah_kategori='7' AND skpd_id = '$skpd_id' AND $column like '%$data%'");
	}
