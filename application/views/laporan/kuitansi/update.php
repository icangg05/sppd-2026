        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">UBAH KUITANSI PANJAR</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            

			<?php echo form_open_multipart('telaah/laporan/kuitansi/update'); ?>
			 ...
			 <?php }?>
				 <table class="table table-bordered table-striped">
					...
					?>
					<input type="hidden" class="form-control" name="kuitansi_panjar_id" value="<?php echo $entry[0]['kuitansi_panjar_id'];?>">
					...
					<tr>
					  ...
					  <td><input type="text" class="form-control" name="jumlah" class="form-control" onkeyup="formatRupiah(this, '.')" value="<?php echo number_format($entry[0]['jumlah'], 0, ',', '.') ?>"></td>
					</tr>
				</table>
              </div>
              <!-- /.box-body -->
