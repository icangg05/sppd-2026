        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">UBAH BENDAHARA</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            

			<?php echo form_open_multipart('telaah/laporan/kuitansi/update_bendahara'); ?>
					  ...
					  <td>
						<select class="form-control select2" name="telaah_ttdbendahara">
							...
							<?php foreach ($bendahara as $v){ ?>
								...
								<?php if($entry[0]['telaah_ttdbendahara']==$v->pegawai_id)
								{ echo "selected";}?> ><?php echo $v->pegawai_nama;?></option>
							<?php } ?>
						</select>
					  </td>
					</tr>
