        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">TAMBAH LAPORAN PENGELUARAN RILL</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            

			<?php $telaah_id2 = base64_encode($this->encrypt->encode($telaah_id, $this->session->userdata('encrypt_key')));	?>
			<?php echo form_open_multipart('telaah/laporan/pengeluaran_rill/create/'.$this->uri->segment(5).'?telaah_id='.$telaah_id2.'=&&pegawai_id='.$pegawai_id.''); ?>
              <div class="box-body">
              ...
              <div class="box-footer">
				 <div class="col-md-6">					
					...
					<a href="<?php echo base_url();?>telaah/laporan/pengeluaran_rill/index/<?php echo $this->uri->segment(5);?>?telaah_id=<?php echo $telaah_id2;?>" class="btn btn-danger btn-sm"><i class="fa fa-close"></i> Kembali</a>
				 </div>
              </div>
            <?php echo form_close(); ?>
          </div>
