 		...
 		<div class="row">
 			...
 			<div class="col-md-12">
 				...
 				<div class="box box-primary">
 					...
 					<?php echo form_open_multipart('setting_admin/anggaran/update'); ?>
 						...
 						<table class="table table-bordered table-striped">
 								...
 								<tr>
 									...
 									<td>
										<select class="form-control" name="mata_anggaran">
											...
											<option value="APBN" <?php if($entry[0]['mata_anggaran']=="APBN"){echo "selected";}?> >APBN</option>
										</select>
									</td>
 									</tr>
 								</table>
 							...
 							<div class="box-footer">
 								<div class="col-md-6">					
 									...
 									<a href="<?php echo base_url();?>setting_admin/anggaran" class="btn btn-danger btn-sm"><i class="fa fa-close"></i> Kembali</a>
 								</div>
 							</div>
 							<?php echo form_close(); ?>
 						</div>
