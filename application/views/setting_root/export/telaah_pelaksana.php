  		...
  		<div class="row">
  			...
  			<div class="col-lg-12 col-xs-12">
  				<div class="box box-success">
  					...
  					<div class="box-header with-border">
  						<?php echo form_open("/setting_root/export/search_laporan_perjalanan/".$this->uri->segment(4));?>
  						<div class="col-md-9">
								<a href="<?php echo base_url();?>setting_root/export" class="btn btn-danger btn-flat">Kembali</a>
								<a href="<?php echo base_url();?>setting_root/export/laporan_perjalanan/<?php echo $this->uri->segment(4)?>" class="btn btn-warning btn-flat">Refresh</a>
  						</div>
  						<div class="col-md-3">
