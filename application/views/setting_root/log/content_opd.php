      ...
      <div class="row">
        ...
        <div class="col-lg-12 col-xs-12">
          <div class="box box-success">
            ...
            <div class="box-header with-border">
             <!--?php echo form_open("log/search_status_log");?!-->
             <div class="col-md-7">
              <a href="<?php echo base_url();?>setting_root/user" class="btn btn-success btn-flat">Kembali</a>
              <!--a href="<?php echo base_url();?>log/status_log?id=<?php echo $this->input->get('id')?>" class="btn btn-warning btn-flat">Refresh</a-->
            </div>
				<!--div class="col-md-2">
