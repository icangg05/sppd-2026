		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="box box-primary">
					...
					<form action="<?php echo base_url();?>setting_root/user/update" method="post" accept-charset="utf-8" id="form1" name="form1">
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<select class="form-control" name="subbagian">
												...
												<?php foreach($subbagian as $v){
													if($entry[0]['subbagian_id'] == $v->subbagian_id){
														echo "<option value='$v->subbagian_id' selected>$v->nama_subbagian</option>" ;
													} else{
														echo "<option value='$v->subbagian_id'>$v->nama_subbagian</option>" ;
													}
												}?>
											</select>
										</div>
