  			...
  			<div class="col-lg-12 col-xs-12">
  				<div class="box box-success">
  					<div class="box-header with-border">
  						<h3 class="box-title">CARI PERIHAL (DPRD)</h3>
  					</div>
  					<div class="box-header with-border">
  						...
  						<?php echo form_close();?>
  						<?php } else { ?>
  						<?php echo form_open("telaah/list_telaah/search_perihal_dprd");?>
  						<div class="col-md-9">
							 <a href="<?php echo base_url();?>telaah/list_telaah/index/dprd" class="btn btn-warning btn-flat">Kembali</a>
  						</div>
  						<div class="col-md-3">
  							<div class="input-group">
