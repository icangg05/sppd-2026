<div class="modal fade" id="perbaiki">
  <div class="modal-dialog">
	<div class="modal-content">
	  <div class="modal-header">
		<h3 class="modal-title">Perbaiki Perjalanan</h3>
	  </div>
	  ...
	  <div class="modal-footer">
		...
		<button type="submit" name="acc" class="btn btn-warning" value="Perbaikan">Perbaiki Perjalanan</button>
	  </div>
	</div>
