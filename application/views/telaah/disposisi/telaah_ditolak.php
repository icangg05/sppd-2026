  			...
  			<div class="col-lg-12 col-xs-12">
  				<div class="box box-success">
  					<div class="box-header with-border">
  						<h3 class="box-title">LIST TELAAH DITOLAK</h3>
  					</div>
  					<div class="box-header with-border">
  						<?php echo form_open('telaah/disposisi/search_telaah_ditolak/'.$this->uri->segment(4)); ?>
  						<div class="col-md-9">
  						</div>	
  						<div class="col-md-3">
  							...
  							foreach($telaah_ditolak as $v){
  								...
  								<tr>
									...
									<?php if($this->uri->segment(4)=='sekda' || $this->uri->segment(4)=='walikota'){
  									...
  									<td><a href="<?php echo base_url();?>telaah/disposisi/lihat_laporan/<?php echo $this->uri->segment(4)?>/<?php echo $v->telaah_kategori?>?telaah_id=<?php echo $telaah_id?>&&telaah_ditolak=1" class="btn btn-sm btn-block btn-primary">Detail Telaah Staff</a></td>
  								</tr>
  								<?php 
  								$number++;
  							} 
