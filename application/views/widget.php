  	...
  	<section class="content">
        ...
        <h2>Rekap Data SPPD Kendari</h2>
          ...
          <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12">
              <a href="<?php echo site_url('telaah/list_telaah/detail_rekap_data/2')?>">
                <div class="info-box">
            ...
            <!-- /.col -->
            <div class="col-md-6 col-sm-6 col-xs-12">
              <a href="<?php echo site_url('telaah/list_telaah/detail_rekap_data/4')?>">
                <div class="info-box">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <a href="<?php echo site_url('telaah/list_telaah/detail_rekap_data/5')?>">
                <div class="info-box">
            ...
            <!-- /.col -->
            <div class="col-md-6 col-sm-6 col-xs-12">
              <a href="<?php echo site_url('telaah/list_telaah/detail_rekap_data/8')?>">
                <div class="info-box">
        ...
        <div class="col-lg-12 col-xs-12">
          ...
          <div class="table-responsive box-body" style="overflow-x:auto;">
            ...
            <?php echo form_open("telaah/list_telaah/getDataBySKPD");?>
